...
-}
   ...
   ... | ◻ , _ | p = {!!}
   gamma₁ {Γ} {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | ◻ , proj₄ | r | [ ([ ._ ] •) ᵇ ] , proj₃ | s | [ • ◻ 〈 x₂ 〉 ᶜ ] , proj₂ | p = {!!}
   gamma₁ {Γ} {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | ◻ , proj₄ | r | [ ([ ._ ] •) ᵇ ] , proj₃ | s | [ • [ ._ ] 〈 x₂ 〉 ᶜ ] , proj₂ | p = {!!}
   gamma₁ {Γ} {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ (◻ •) ᵇ ] , proj₂ | r = {!!}
   gamma₁ {Γ} {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | [ ([ x ] •) ᵇ ] , proj₂ | r
      with step (E′/E (⊖₁ 𝐸)) (target E P) | inspect (step (E′/E (⊖₁ 𝐸))) (target E P) |
   ...
   ... | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   ... | [ • [ .(ᴺ.suc x) ] 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | ◻ , proj₂ | s | [ • ◻ 〈 x₂ 〉 ᶜ ] , proj₄ | u = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | ◻ , proj₂ | s | [ • [ .x ] 〈 x₂ 〉 ᶜ ] , proj₄ | u = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ (◻ •) ᵇ ] , proj₂ | s | [ • ◻ 〈 x₃ 〉 ᶜ ] , proj₄ | u = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₂ | s | [ • ◻ 〈 x₃ 〉 ᶜ ] , proj₄ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , _ | w = {!!}
   ... | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   ... | [ • [ .(ᴺ.suc x) ] 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , _ | r | [ (◻ •) ᵇ ] , _ | s | [ • [ .x ] 〈 x₃ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , _ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , _ | s | [ • [ .x ] 〈 x₃ 〉 ᶜ ] , _ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , _ | _ = {!!}
   ... | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | _ = {!!}
   ... | [ • [ .(ᴺ.suc x) ] 〈 x₂ 〉 ᶜ ] , _ | _ = {!!}
