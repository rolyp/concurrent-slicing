...
-}
   ...
   gamma₁ {E = E ᵇ│ Q₀} {E′ │ᵥ .F} (_│ᵥᵇ_ {a = x •} 𝐸 F) [ P │ Q ]
      with (idᶠ *ᵇ) (E/E′ (⊖₁ 𝐸))
   ... | id*E/E′ -- rewrite *-preserves-id ((ᴿ.push *) a)
      with step E′ P | step F Q | step (E′/E (⊖₁ 𝐸)) (tgt E P) | step ((ᴿ.push *ᵇ) F) ((push *̃) Q)
   ... | ◻ , R′ | ◻ , S₁ | ◻ , P′ | ◻ , S′ with step id*E/E′ ((ᴿ̃.repl ◻ *̃) R′)
   ... | ◻ , S″ = {!!}
   gamma₁ {Γ} {.((x₁ •) ᵇ)} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │ᵥ .F} (_│ᵥᵇ_ {._} {._} {._} {._} {._} {.Q₀} {x₁ •} 𝐸 F) [ P₁ │ Q ] | id*E/E′ | ◻ , R′ | ◻ , S₁ | ◻ , P′ | ◻ , S′ | [ x₂ ᵇ ] , ◻ = ?
   ... | p , [ x₂ ] = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │ᵥ .F} (_│ᵥᵇ_ {a = x •} 𝐸 F) [ P │ Q ] | id*E/E′ | _ , R′ | ◻ , S₁ | _ , P′ | [ x₁ ] , S′ = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │ᵥ .F} (_│ᵥᵇ_ {a = x •} 𝐸 F) [ P │ Q ] | id*E/E′ | ◻ , R′ | _ , S₁ | [ (._ •) ᵇ ] , P′ | _ , S′ = {!!} -- impossible
   gamma₁ {E = E ᵇ│ Q₀} {E′ │ᵥ .F} (_│ᵥᵇ_ {a = x •} 𝐸 F) [ P │ Q ] | id*E/E′ | _ , R′ | [ (• ._) ᵇ ] , S₁ | _ , P′ | ◻ , S′ = {!!} -- impossible
   gamma₁ {E = E ᵇ│ Q₀} {E′ │ᵥ .F} (_│ᵥᵇ_ {a = x •} 𝐸 F) [ P │ Q ] | id*E/E′ | ◻ , R′ | [ (• ._) ᵇ ] , S₁ | ◻ , P′ | [ (• ._) ᵇ ] , S′ = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │ᵥ .F} (_│ᵥᵇ_ {a = x •} 𝐸 F) [ P │ Q ] | id*E/E′ | [ x₁ ] , R′ | _ , S₁ | ◻ , P′ | _ , S′ = {!!} -- impossible
   gamma₁ {E = E ᵇ│ Q₀} {E′ │ᵥ .F} (_│ᵥᵇ_ {a = x •} 𝐸 F) [ P │ Q ] | id*E/E′ | [ x₁ ] , R′ | ◻ , S₁ | [ (._ •) ᵇ ] , P′ | ◻ , S′ = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │ᵥ .F} (_│ᵥᵇ_ {a = x •} 𝐸 F) [ P │ Q ] | id*E/E′ | [ x₁ ] , R′ | [ (• ._) ᵇ ] , S₁ | [ ._ • ᵇ ] , P′ | [ (• ._) ᵇ ] , S′ = {!!}
