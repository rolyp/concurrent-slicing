...
-}
   ...
   ... | ◻ , R′ | ◻ , R = {!!}
   gamma₁ {E = νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P ] | ◻ , R′ | [ (• ._) ᵇ ] , R = {!!}
   gamma₁ {E = νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P ] | [ (• ._) ᵇ ] , R′ | ◻ , R = {!!}
   gamma₁ {E = νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P ] | [ (• ._) ᵇ ] , R′ | [ (• ._) ᵇ ] , R
      with step ((ᴿ.swap *ᶜ) (E′/E (⊖₁ 𝐸))) ((swap *̃) R) | step ((ᴿ.swap *ᶜ) (E/E′ (⊖₁ 𝐸))) ((swap *̃) R′)
   ... | ◻ , S | ◻ , S′ = {!!}
   ... | ◻ , S | [ • ._ 〈 ◻ 〉 ᶜ ] , S′ = {!!}
   ... | ◻ , S | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , S′ = {!!}
   ... | [ • ._ 〈 ◻ 〉 ᶜ ] , S | ◻ , S′ = {!!}
   ... | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , S | ◻ , S′ = {!!}
   ... | [ • ._ 〈 ◻ 〉 ᶜ ] , S | [ • ._ 〈 ◻ 〉 ᶜ ] , S′ = {!!}
   ... | [ • ._ 〈 ◻ 〉 ᶜ ] , S | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , S′ = {!!}
   ... | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , S | [ • ._ 〈 ◻ 〉 ᶜ ] , S′ = {!!}
   ... | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , S | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , S′ = {!!}
