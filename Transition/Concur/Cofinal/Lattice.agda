...
-}
   ...
   ... | ◻ , P′ | [ ≡P′ ] =
      gamma₁-│•ᵇ 𝐸 F P Q (target ((ᴿ.push *ᶜ) F) ((push *̃) Q)) R′ P′ (,-inj₂ eq) (,-inj₂ ≡P′) refl (gamma₁ 𝐸 P)
   ... | [ (◻ •) ᵇ ] , P′ | [ ≡P′ ] =
      gamma₁-│•ᵇ 𝐸 F P Q (target ((ᴿ.push *ᶜ) F) ((push *̃) Q)) R′ P′ (,-inj₂ eq) (,-inj₂ ≡P′) refl (gamma₁ 𝐸 P)
   ... | [ ([ ._ ] •) ᵇ ] , P′ | [ ≡P′ ]
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , S† | [ ≡S† ] = gamma₁-│•ᵇ 𝐸 F P Q S† R′ P′ (,-inj₂ eq) (,-inj₂ ≡P′) (,-inj₂ ≡S†) (gamma₁ 𝐸 P)
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , S† | [ ≡S† ] = gamma₁-│•ᵇ 𝐸 F P Q S† R′ P′ (,-inj₂ eq) (,-inj₂ ≡P′) (,-inj₂ ≡S†) (gamma₁ 𝐸 P)
   ... | [ • [ ._ ] 〈 _ 〉 ᶜ ] , S† | [ eq‡ ] = {!!}
   ...
   ... | [ • [ ._ ] 〈 _ 〉 ᶜ ] , S† | [ ≡S† ] = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ eq ] | ◻ , P′ | [ ≡P′ ] | [ • ◻ 〈 _ 〉 ᶜ ] , S‡ | [ ≡S‡ ] = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ eq ] | ◻ , P′ | [ ≡P′ ] | [ • [ .x ] 〈 _ 〉 ᶜ ] , S‡ | [ ≡S‡ ] = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ eq ] | [ ◻ • ᵇ ] , P′ | [ ≡P′ ] | [ • ◻ 〈 _ 〉 ᶜ ] , S‡ | [ ≡S‡ ] = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ eq ] | [ [ ._ ] • ᵇ ] , P′ | [ ≡P′ ] | [ • ◻ 〈 _ 〉 ᶜ ] , S‡ | [ ≡S‡ ]
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , S† | [ ≡S† ] = {!!}
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , S† | [ ≡S† ] = {!!}
   ... | [ • [ ._ ] 〈 _ 〉 ᶜ ] , S† | [ ≡S† ] = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ eq ] | [ ◻ • ᵇ ] , P′ | [ ≡P′ ] | [ • [ .x ] 〈 _ 〉 ᶜ ] , S‡ | [ ≡S‡ ] = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (_│•ᵇ_ {y = y} {a = a} 𝐸 F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ eq ] | [ [ ._ ] • ᵇ ] , P′ | [ ≡P′ ] | [ • [ .x ] 〈 _ 〉 ᶜ ] , S‡ | [ ≡S‡ ]
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , S† | [ ≡S† ] = {!!}
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , S† | [ ≡S† ] = {!!}
   ... | [ • [ ._ ] 〈 _ 〉 ᶜ ] , S† | [ ≡S† ] = {!!}
