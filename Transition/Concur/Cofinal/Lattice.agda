...
-}
   ...
   gamma₁ {E = νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P ] with step E′ P | step E P
   ... | ◻ , R′ | ◻ , R = {!!}
   ... | ◻ , R′ | [ x₁ ] , R = {!!}
   gamma₁ {Γ} {._} {._} {.ˣ∇ˣ} {._} {._} {._} {νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P₁ ] | [ (• ._) ᵇ ] , R′ | ◻ , R₂ = {!!}
   ... | [ (• ._) ᵇ ] , R′ | [ (• ._) ᵇ ] , R
      with step ((ᴿ.swap *ᶜ) (E′/E (⊖₁ 𝐸))) ((swap *̃) R) | step ((ᴿ.swap *ᶜ) (E/E′ (⊖₁ 𝐸))) ((swap *̃) R′)
   gamma₁ {Γ} {._} {._} {.ˣ∇ˣ} {._} {._} {._} {νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P₁ ] | [ (• ._) ᵇ ] , R′ | [ (• ._) ᵇ ] , R₂ | ◻ , proj₂ | ◻ , proj₄ = {!!}
   gamma₁ {Γ} {._} {._} {.ˣ∇ˣ} {._} {._} {._} {νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P₁ ] | [ (• ._) ᵇ ] , R′ | [ (• ._) ᵇ ] , R₂ | ◻ , proj₂ | [ • ._ 〈 ◻ 〉 ᶜ ] , proj₄ = {!!}
   gamma₁ {Γ} {._} {._} {.ˣ∇ˣ} {._} {._} {._} {νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P₁ ] | [ (• ._) ᵇ ] , R′ | [ (• ._) ᵇ ] , R₂ | ◻ , proj₂ | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , proj₄ = {!!}
   gamma₁ {Γ} {._} {._} {.ˣ∇ˣ} {._} {._} {._} {νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P₁ ] | [ (• ._) ᵇ ] , R′ | [ (• ._) ᵇ ] , R₂ | [ • ._ 〈 ◻ 〉 ᶜ ] , proj₂ | ◻ , proj₄ = {!!}
   gamma₁ {Γ} {._} {._} {.ˣ∇ˣ} {._} {._} {._} {νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P₁ ] | [ (• ._) ᵇ ] , R′ | [ (• ._) ᵇ ] , R₂ | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , proj₂ | ◻ , proj₄ = {!!}
   gamma₁ {Γ} {._} {._} {.ˣ∇ˣ} {._} {._} {._} {νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P₁ ] | [ (• ._) ᵇ ] , R′ | [ (• ._) ᵇ ] , R₂ | [ • ._ 〈 ◻ 〉 ᶜ ] , proj₂ | [ • ._ 〈 ◻ 〉 ᶜ ] , proj₄ = {!!}
   gamma₁ {Γ} {._} {._} {.ˣ∇ˣ} {._} {._} {._} {νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P₁ ] | [ (• ._) ᵇ ] , R′ | [ (• ._) ᵇ ] , R₂ | [ • ._ 〈 ◻ 〉 ᶜ ] , proj₂ | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , proj₄ = {!!}
   gamma₁ {Γ} {._} {._} {.ˣ∇ˣ} {._} {._} {._} {νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P₁ ] | [ (• ._) ᵇ ] , R′ | [ (• ._) ᵇ ] , R₂ | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , proj₂ | [ • ._ 〈 ◻ 〉 ᶜ ] , proj₄ = {!!}
   gamma₁ {Γ} {._} {._} {.ˣ∇ˣ} {._} {._} {._} {νᵇ E} {νᵇ E′} (νˣˣ 𝐸) [ ν P₁ ] | [ (• ._) ᵇ ] , R′ | [ (• ._) ᵇ ] , R₂ | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , proj₂ | [ • ._ 〈 [ .(ᴺ.suc ᴺ.zero) ] 〉 ᶜ ] , proj₄ = {!!}
