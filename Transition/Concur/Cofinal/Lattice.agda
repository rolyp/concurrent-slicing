...
-}
   ...
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      _ | [ eq′ ] | ◻ , _ | [ _ ] | [ ([ ._ ] •) ᵇ ] , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | p = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      _ | [ eq′ ] | ◻ , _ | [ _ ] | [ ([ ._ ] •) ᵇ ] , _ | s | [ • [ ._ ] 〈 _ 〉 ᶜ ] , _ | p = {!!}
   ...
   ... | [ • [ ._ ] 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      _ | [ eq′ ] | [ [ x ] • ᵇ ] , _ | r | ◻ , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      _ | [ eq′ ] | [ [ x ] • ᵇ ] , _ | r | ◻ , _ | s | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      _ | [ eq′ ] | [ [ x ] • ᵇ ] , _ | r | [ ◻ • ᵇ ] , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      _ | [ eq′ ] | [ [ x ] • ᵇ ] , _ | r | [ [ ._ ] • ᵇ ] , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , _ | w = {!!}
   ... | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   ... | [ • [ ._ ] 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      _ | [ eq′ ] | [ [ x ] • ᵇ ] , _ | r | [ ◻ • ᵇ ] , _ | s | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (_│•ᵇ_ {y = y} {a = a} 𝐸 F) [ P │ Q ] |
      _ | [ eq′ ] | [ [ x ] • ᵇ ] , _ | r | [ [ ._ ] • ᵇ ] , _ | s | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , _ | _ = {!!}
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , _ | _ = {!!}
   ... | [ • [ ._ ] 〈 _ 〉 ᶜ ] , _ | _ = {!!}
