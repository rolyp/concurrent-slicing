...
-}
   ...
   gamma₁ {a = a ᵇ} (_ᵇ│•_ {y = y} {F = F} {F′} E 𝐹) [ P │ Q ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₂ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₃ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | _ , ◻ | ◻ , ◻ =
      ...
      [ ◻ │ ◻ ]
      ∎
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₂ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₃ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | ◻ , ◻ | ◻ , [ x₁ ] = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₂ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₃ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | ◻ , ◻ | [ x₁ ] , ◻ = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₃ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₄ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | ◻ , ◻ | [ x₁ ] , [ x₂ ] = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₂ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₃ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | ◻ , [ x₁ ] | ◻ , ◻ = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₃ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₄ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | ◻ , [ x₁ ] | ◻ , [ x₂ ] = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₃ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₄ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | ◻ , [ x₁ ] | [ x₂ ] , ◻ = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₄ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₅ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | ◻ , [ x₁ ] | [ x₂ ] , [ x₃ ] = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₃ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₄ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | [ x₁ ] , ◻ | ◻ , [ x₂ ] = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₃ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₄ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | [ x₁ ] , ◻ | [ x₂ ] , ◻ = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₄ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₅ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | [ x₁ ] , ◻ | [ x₂ ] , [ x₃ ] = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₃ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₄ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | [ x₁ ] , [ x₂ ] | ◻ , ◻ = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₄ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₅ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | [ x₁ ] , [ x₂ ] | ◻ , [ x₃ ] = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₄ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₅ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | [ x₁ ] , [ x₂ ] | [ x₃ ] , ◻ = {!!}
   gamma₁ {Γ} {a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₅ 〉 ᶜ ] | [ ([ .(ᴺ.suc x) ] •) ᵇ ] | [ • [ .(ᴺ.suc x) ] 〈 x₆ 〉 ᶜ ] | ◻ , ◻ | ◻ , ◻ | [ x₁ ] , [ x₂ ] | [ x₃ ] , [ x₄ ] = {!!}
   gamma₁ {a = a ᵇ} (_ᵇ│•_ {y = y} {F = F} {F′} E 𝐹) [ P │ Q ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₂ 〉 ᶜ ] | [ ([ ._ ] •) ᵇ ] | [ • [ ._ ] 〈 x₃ 〉 ᶜ ] | ◻ , ◻ | ◻ , [ x₁ ] = {!!}
   gamma₁ {a = a ᵇ} (_ᵇ│•_ {y = y} {F = F} {F′} E 𝐹) [ P │ Q ] | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₂ 〉 ᶜ ] | [ ([ ._ ] •) ᵇ ] | [ • [ ._ ] 〈 x₃ 〉 ᶜ ] | ◻ , ◻ | [ x₁ ] , ◻ = {!!}
   gamma₁ {a = a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ]
       | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₃ 〉 ᶜ ] | [ ([ ._ ] •) ᵇ ] | [ • [ ._ ] 〈 x₄ 〉 ᶜ ] | ◻ , ◻ | [ x₁ ] , [ x₂ ] = {!!}
   gamma₁ {a = a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ]
       | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₃ 〉 ᶜ ] | [ ([ ._ ] •) ᵇ ] | [ • [ ._ ] 〈 x₄ 〉 ᶜ ] | ◻ , [ x₁ ] | proj₃ , proj₄ = {!!}
   gamma₁ {a = a ᵇ} (E ᵇ│• 𝐹) [ P₁ │ Q₁ ]
       | [ ([ x ] •) ᵇ ] | [ • [ .x ] 〈 x₃ 〉 ᶜ ] | [ ([ ._ ] •) ᵇ ] | [ • [ ._ ] 〈 x₄ 〉 ᶜ ] | [ x₁ ] , proj₂ | proj₃ , proj₄ = {!!}
   gamma₁ 𝐸 P = {!!}
{-
   gamma₁ (E ᶜ│• 𝐸) P₁ = {!!}
   gamma₁ (𝐸 │ᵥᵇ F) P₁ = {!!}
