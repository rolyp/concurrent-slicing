...
-}
   ...
   ... | [ ([ ._ ] •) ᵇ ] , _ | [ • ◻ 〈 _ 〉 ᶜ ] , _ = {!!}
   ... | [ ([ ._ ] •) ᵇ ] , _ | [ • [ ._ ] 〈 _ 〉 ᶜ ] , _ = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | _ | [ (◻ •) ᵇ ] , proj₂ | proj₁ , proj₄ = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | _ | [ ([ x ] •) ᵇ ] , proj₂ | ◻ , proj₄ = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | _ | [ ([ x ] •) ᵇ ] , proj₂ | [ • ◻ 〈 x₂ 〉 ᶜ ] , proj₄ = {!!}
   gamma₁ {E = E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | _ | [ ([ x ] •) ᵇ ] , proj₂ | [ • [ .x ] 〈 x₂ 〉 ᶜ ] , proj₄ = {!!}
{-
