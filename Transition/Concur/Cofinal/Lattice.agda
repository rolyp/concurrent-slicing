...
-}
   ...
   gamma₁ {a = a ᵇ} (_ᵇ│•_ {y = y} {F = F} {F′} E 𝐹) [ P │ Q ]
      with fwd E P | fwd F′ Q | fwd ((ᴿ.push *ᵇ) E) ((push *̃) P) | fwd (E′/E (⊖₁ 𝐹)) (π₂ (fwd F Q))
   ... | ◻ , _ | _ | ◻ , _ | _ = ≅-to-≡ (≅-trans
   ...
   ... | ◻ , _ | _ | [ (◻ •) ᵇ ] , _ | _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | ◻ , _ | _ | [ ([ ._ ] •) ᵇ ] , _ | ◻ , _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | ◻ , _ | _ | [ ([ ._ ] •) ᵇ ] , _ | [ • ◻ 〈 _ 〉 ᶜ ] , _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | ◻ , _ | _ | [ ([ ._ ] •) ᵇ ] , _ | [ • [ ._ ] 〈 _ 〉 ᶜ ] , _ = {!!}
   ... | [ (◻ •) ᵇ ] , _ | _ | ◻ , _ | _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | [ (◻ •) ᵇ ] , _ | _ | [ (◻ •) ᵇ ] , _ | _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | [ (◻ •) ᵇ ] , _ | _ | [ ([ ._ ] •) ᵇ ] , _ | ◻ , _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | [ (◻ •) ᵇ ] , _ | _ | [ ([ ._ ] •) ᵇ ] , _ | [ • ◻ 〈 _ 〉 ᶜ ] , _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | [ (◻ •) ᵇ ] , _ | _ | [ ([ ._ ] •) ᵇ ] , _ | [ • [ ._ ] 〈 _ 〉 ᶜ ] , _ = {!!}
   ... | [ ([ _ ] •) ᵇ ] , _ | ◻ , _ | ◻ , _ | _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | [ ([ _ ] •) ᵇ ] , _ | ◻ , _ | [ (◻ •) ᵇ ] , _ | _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | [ ([ x ] •) ᵇ ] , _ | ◻ , _ | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , _ | d = {!!}
   ... | [ ([ _ ] •) ᵇ ] , _ | [ • ◻ 〈 _ 〉 ᶜ ] , _ | ◻ , _ | _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | [ ([ _ ] •) ᵇ ] , _ | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | [ (◻ •) ᵇ ] , _ | d = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | [ ([ _ ] •) ᵇ ] , _ | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | [ ([ ._ ] •) ᵇ ] , _ | ◻ , _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | [ ([ _ ] •) ᵇ ] , _ | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | [ ([ ._ ] •) ᵇ ] , _ | [ • ◻ 〈 x₃ 〉 ᶜ ] , _ = ≅-to-≡ (≅-trans
      (◻-cong (cong₂ _│_ (pop∘suc-push y (target E)) (sym (γ₁ 𝐹))))
      (≅-sym (reduce-ᵇ∇ᶜ (cong₂ _│_ (sym (pop∘suc-push y (target E))) (γ₁ 𝐹)) _)))
   ... | [ ([ x ] •) ᵇ ] , _ | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , _ | [ • [ .(ᴺ.suc x) ] 〈 x₃ 〉 ᶜ ] , _ = {!!}
   ... | [ ([ x ] •) ᵇ ] , _ | [ • [ .x ] 〈 x₂ 〉 ᶜ ] , _ | ◻ , _ | d = {!!}
   ... | [ ([ x ] •) ᵇ ] , _ | [ • [ .x ] 〈 x₂ 〉 ᶜ ] , _ | [ (◻ •) ᵇ ] , _ | d = {!!}
   ... | [ ([ x ] •) ᵇ ] , _ | [ • [ .x ] 〈 x₂ 〉 ᶜ ] , _ | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , _ | ◻ , _ = {!!}
   ... | [ ([ x ] •) ᵇ ] , _ | [ • [ .x ] 〈 x₂ 〉 ᶜ ] , _ | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , _ | [ • ◻ 〈 x₃ 〉 ᶜ ] , _ = {!!}
   ... | [ ([ x ] •) ᵇ ] , _ | [ • [ .x ] 〈 x₂ 〉 ᶜ ] , _ | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , _ | [ • [ .(ᴺ.suc x) ] 〈 x₃ 〉 ᶜ ] , _ = {!!}
   gamma₁ 𝐸 P = {!!}
{-
   gamma₁ (E ᶜ│• 𝐸) P₁ = {!!}
   gamma₁ (𝐸 │ᵥᵇ F) P₁ = {!!}
