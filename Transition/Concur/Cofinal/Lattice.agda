...
-}
   ...
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , S† | [ ≡S† ] = gamma₁-│•ᵇ 𝐸 F P Q S† R′ P′ (,-inj₂ ≡R′) (,-inj₂ ≡P′) (,-inj₂ ≡S†) (gamma₁ 𝐸 P)
   ... | [ • [ ._ ] 〈 y′ 〉 ᶜ ] , S† | [ ≡S† ] = {!!} -- PROBLEM EQUATING y' WITH ◻
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ ◻ • ᵇ ] , R′ | [ ≡R′ ] = {!!} -- MISSING SUB-CASES
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ ≡R′ ]
      with step (E′/E (⊖₁ 𝐸)) (target E P) | inspect (step (E′/E (⊖₁ 𝐸))) (target E P) |
           step F Q | inspect (step F) Q
   ... | ◻ , P′ | [ ≡P′ ] | ◻ , S‡ | [ ≡S‡ ] = {!!} -- MORE SUB-CASES
   ... | [ (◻ •) ᵇ ] , P′ | [ ≡P′ ] | ◻ , S‡ | [ ≡S‡ ] = {!!}
   ... | [ ([ ._ ] •) ᵇ ] , P′ | [ ≡P′ ] | ◻ , S‡ | [ ≡S‡ ]
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , S† | [ ≡S† ] = {!!}
   ...
   ... | [ • [ ._ ] 〈 _ 〉 ᶜ ] , S† | [ ≡S† ] = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ ≡R′ ] | ◻ , P′ | [ ≡P′ ] | [ • ◻ 〈 _ 〉 ᶜ ] , S‡ | [ ≡S‡ ] = {!!} -- PROBLEM EQUATING y' WITH ◻
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ ≡R′ ] | ◻ , P′ | [ ≡P′ ] | [ • [ .x ] 〈 _ 〉 ᶜ ] , S‡ | [ ≡S‡ ] = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ ≡R′ ] | [ ◻ • ᵇ ] , P′ | [ ≡P′ ] | [ • ◻ 〈 _ 〉 ᶜ ] , S‡ | [ ≡S‡ ] = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ ≡R′ ] | [ [ ._ ] • ᵇ ] , P′ | [ ≡P′ ] | [ • ◻ 〈 _ 〉 ᶜ ] , S‡ | [ ≡S‡ ]
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , S† | [ ≡S† ] = {!!}
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , S† | [ ≡S† ] = {!!}
   ... | [ • [ ._ ] 〈 _ 〉 ᶜ ] , S† | [ ≡S† ] = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ ≡R′ ] | [ ◻ • ᵇ ] , P′ | [ ≡P′ ] | [ • [ .x ] 〈 _ 〉 ᶜ ] , S‡ | [ ≡S‡ ] = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (_│•ᵇ_ {y = y} {a = a} 𝐸 F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , R′ | [ ≡R′ ] | [ [ ._ ] • ᵇ ] , P′ | [ ≡P′ ] | [ • [ .x ] 〈 y′ 〉 ᶜ ] , S‡ | [ ≡S‡ ]
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , S† | [ ≡S† ] = {!!}
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , S† | [ ≡S† ] = {!!}
   ... | [ • [ ._ ] 〈 y″ 〉 ᶜ ] , S† | [ ≡S† ] = {!!} -- PROBLEM EQUATING y′ WITH y″
