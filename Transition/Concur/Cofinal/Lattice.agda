module Transition.Concur.Cofinal.Lattice where
   ...
   gamma₁-│•ᵇ {y = y} {a = a} 𝐸 F pop-y*E/E′ P Q R′ P′ eq′ IH =
      let P″ = target (E/E′ (⊖₁ 𝐸)) R′
          ...
          nib = let open ≅-Reasoning in
             begin
                (pop {x₀ = ᴺ.suc y} ◻ *̃) P′
             ≅⟨ ≅-cong✴ ↓_ (swap-swap (γ₁ 𝐸)) (pop {x₀ = ᴺ.suc y} ◻ *̃) (swap-swap̃ wib) ⟩
...
-}
   ...
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | _ | ◻ , _ | r | [ ([ ._ ] •) ᵇ ] , _ | s | [ • [ ._ ] 〈 _ 〉 ᶜ ] , _ | p = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | _ | [ ◻ • ᵇ ] , _ | r = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | _ | [ [ x ] • ᵇ ] , _ | r
      with step (E′/E (⊖₁ 𝐸)) (target E P) | inspect (step (E′/E (⊖₁ 𝐸))) (target E P) |
   ...
   ... | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   ... | [ • [ ._ ] 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | _ | [ [ x ] • ᵇ ] , _ | r | ◻ , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | _ | [ [ x ] • ᵇ ] , _ | r | ◻ , _ | s | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | _ | [ [ x ] • ᵇ ] , _ | r | [ ◻ • ᵇ ] , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | _ | [ [ x ] • ᵇ ] , _ | r | [ [ ._ ] • ᵇ ] , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , _ | w = {!!}
   ... | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   ... | [ • [ ._ ] 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | _ | [ [ x ] • ᵇ ] , _ | r | [ ◻ • ᵇ ] , _ | s | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (_│•ᵇ_ {y = y} {a = a} 𝐸 F) [ P │ Q ] | _ | [ [ x ] • ᵇ ] , _ | r | [ [ ._ ] • ᵇ ] , _ | s | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , _ | _ = {!!}
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , _ | _ = {!!}
   ... | [ • [ ._ ] 〈 _ 〉 ᶜ ] , _ | _ = {!!}
