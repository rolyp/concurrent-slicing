...
-}
   ...
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      ◻ , _ | [ _ ] | [ ([ ._ ] •) ᵇ ] , _ | [ eq† ] | [ • ◻ 〈 _ 〉 ᶜ ] , _ | p = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      ◻ , _ | [ _ ] | [ ([ ._ ] •) ᵇ ] , _ | [ eq† ] | [ • [ ._ ] 〈 _ 〉 ᶜ ] , _ | p = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ ◻ • ᵇ ] , _ | r = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , _ | r
   ...
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , _ | r | ◻ , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , _ | r | ◻ , _ | s | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , _ | r | [ ◻ • ᵇ ] , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , _ | r | [ [ ._ ] • ᵇ ] , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , _ | w = {!!}
   ... | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   ... | [ • [ ._ ] 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , _ | r | [ ◻ • ᵇ ] , _ | s | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (_│•ᵇ_ {y = y} {a = a} 𝐸 F) [ P │ Q ] |
      [ [ x ] • ᵇ ] , _ | r | [ [ ._ ] • ᵇ ] , _ | s | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , _ | _ = {!!}
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , _ | _ = {!!}
   ... | [ • [ ._ ] 〈 _ 〉 ᶜ ] , _ | _ = {!!}
