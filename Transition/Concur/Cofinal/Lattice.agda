...
-}
   ...
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | ◻ , proj₂ | s | ◻ , proj₄ | u = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ (◻ •) ᵇ ] , proj₂ | s | ◻ , proj₄ | u = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₂ | s | ◻ , proj₄ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₃ | s | ◻ , proj₄ | u | ◻ , proj₂ | w = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₃ | s | ◻ , proj₄ | u | [ • ◻ 〈 x₂ 〉 ᶜ ] , proj₂ | w = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₃ | s | ◻ , proj₄ | u | [ • [ .(ᴺ.suc x) ] 〈 x₂ 〉 ᶜ ] , proj₂ | w = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | ◻ , proj₂ | s | [ • ◻ 〈 x₂ 〉 ᶜ ] , proj₄ | u = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | ◻ , proj₂ | s | [ • [ .x ] 〈 x₂ 〉 ᶜ ] , proj₄ | u = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ (◻ •) ᵇ ] , proj₂ | s | [ • ◻ 〈 x₃ 〉 ᶜ ] , proj₄ | u = {!!}

   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₂ | s | [ • ◻ 〈 x₃ 〉 ᶜ ] , proj₄ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₃ | s | [ • ◻ 〈 x₃ 〉 ᶜ ] , proj₄ | u | ◻ , proj₂ | w = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₃ | s | [ • ◻ 〈 x₃ 〉 ᶜ ] , proj₄ | u | [ • ◻ 〈 x₂ 〉 ᶜ ] , proj₂ | w = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₃ | s | [ • ◻ 〈 x₃ 〉 ᶜ ] , proj₄ | u | [ • [ .(ᴺ.suc x) ] 〈 x₂ 〉 ᶜ ] , proj₂ | w = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ (◻ •) ᵇ ] , proj₂ | s | [ • [ .x ] 〈 x₃ 〉 ᶜ ] , proj₄ | u = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₂ | s | [ • [ .x ] 〈 x₃ 〉 ᶜ ] , proj₄ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₃ | s | [ • [ .x ] 〈 x₃ 〉 ᶜ ] , proj₄ | u | ◻ , proj₂ | w = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₃ | s | [ • [ .x ] 〈 x₃ 〉 ᶜ ] , proj₄ | u | [ • ◻ 〈 x₂ 〉 ᶜ ] , proj₂ | w = {!!}
   gamma₁ {Γ} {._} {.(τ ᶜ)} {.ᵇ∇ᶜ} {._} {._} {._} {E ᵇ│ Q₀} {E′ │• .F} (𝐸 │•ᵇ F) [ P₁ │ Q ] | [ ([ x ] •) ᵇ ] , proj₅ | r | [ ([ .(ᴺ.suc x) ] •) ᵇ ] , proj₃ | s | [ • [ .x ] 〈 x₃ 〉 ᶜ ] , proj₄ | u | [ • [ .(ᴺ.suc x) ] 〈 x₂ 〉 ᶜ ] , proj₂ | w = {!!}
{-
