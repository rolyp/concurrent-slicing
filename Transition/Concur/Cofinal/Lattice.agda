...
-}
   ...
   gamma₁-│•ᵇ : ∀ {Γ x y P₀ R₀ R′₀ S₀ Q₀} {a : Actionᵇ Γ} {E : P₀ —[ a ᵇ - _ ]→ R₀} {E′ : P₀ —[ (x •) ᵇ - _ ]→ R′₀}
               ...
               (P′ : ↓ S (⊖₁ 𝐸)) (S₀′ : ↓ (ᴿ.push *) S₀) →
               let S‡ = [ (pop {x₀ = ᴺ.suc y} ◻ *̃) P′ │ S₀′ ]
                   S† = braiding (ᵇ∇ᶜ {a = a} {τ}) {0}
...
{-
   ...
   ... | ◻ , _ | p = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | ◻ , _ | r | [ ([ ._ ] •) ᵇ ] , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | p = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | ◻ , _ | r | [ ([ ._ ] •) ᵇ ] , _ | s | [ • [ ._ ] 〈 _ 〉 ᶜ ] , _ | p = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | [ ◻ • ᵇ ] , _ | r = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | [ [ x ] • ᵇ ] , _ | r
      with step (E′/E (⊖₁ 𝐸)) (target E P) | inspect (step (E′/E (⊖₁ 𝐸))) (target E P) |
   ...
   ... | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   ... | [ • [ .(ᴺ.suc x) ] 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | [ [ x ] • ᵇ ] , _ | r | ◻ , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | [ [ x ] • ᵇ ] , _ | r | ◻ , _ | s | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | [ [ x ] • ᵇ ] , _ | r | [ ◻ • ᵇ ] , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u = {!!}
   gamma₁ {E = E ᵇ│ _} {E′ │• .F} (𝐸 │•ᵇ F) [ P │ Q ] | [ [ x ] • ᵇ ] , _ | r | [ [ ._ ] • ᵇ ] , _ | s | [ • ◻ 〈 _ 〉 ᶜ ] , _ | u
      with step ((ᴿ.push *ᶜ) F) ((push *̃) Q) | inspect (step ((ᴿ.push *ᶜ) F)) ((push *̃) Q)
   ... | ◻ , _ | w = {!!}
   ... | [ • ◻ 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
   ... | [ • [ .(ᴺ.suc x) ] 〈 x₂ 〉 ᶜ ] , _ | w = {!!}
