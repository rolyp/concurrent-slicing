...
-}
   ...
   gamma₁ {E = P₀ │ᵇ F} {.E │ᵥ F′} (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E 𝐹) [ P │ Q ] = {!!}
   gamma₁ {E = P₀ │ᵇ F} {.E │ᵥ F′} (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) [ P │ Q ]
      with step E P | step ((ᴺ.suc *ᵇ) E) ((push *̃) P) | step F′ Q | step (E′/E (⊖₁ 𝐹)) (tgt F Q)
   ... | ◻ , R | [ ._ • ᵇ ] , P″ | _ , S′ | _ , P′ = {!!} -- impossible
   ... | [ ._ • ᵇ ] , R | ◻ , P″ | _ , S′ | _ , P′ = {!!} -- impossible
   ... | _ , R | _ , P″ | ◻ , S′ | [ _ ] , P′ = {!!} -- impossible
   ... | _ , R | _ , P″ | [ _ ] , S′ | ◻ , P′ = {!!} -- impossible
   ... | ◻ , R | ◻ , P″ | ◻ , S′ | ◻ , P′ = {!!}
   ... | ◻ , R | ◻ , P″ | [ _ ] , S′ | [ _ ] , P′ = {!!}
   ... | [ ._ • ᵇ ] , R | [ ._ • ᵇ ] , P″ | ◻ , S′ | ◻ , P′ = {!!}
