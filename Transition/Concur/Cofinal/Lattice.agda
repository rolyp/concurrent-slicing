...
-}
   ...
   gamma₁ {E = E ᵇ│ Q₀} {E′ │ᵥ .F} (_│ᵥᵇ_ {x = x} {a = x′ •} 𝐸 F) [ P │ Q ]
      with (idᶠ *ᵇ) (E/E′ (⊖₁ 𝐸)) | step E′ P | step F Q | step (E′/E (⊖₁ 𝐸)) (tgt E P) | step ((ᴿ.push *ᵇ) F) ((push *̃) Q) |
           inspect (step (E′/E (⊖₁ 𝐸))) (tgt E P) | inspect (step F) Q | inspect (step ((ᴿ.push *ᵇ) F)) ((push *̃) Q)
   ... | id*E/E′ | ◻ , R′ | ◻ , S | ◻ , P′ | ◻ , S′ | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] =
      let open │ᵥᵇ 𝐸 F P′ S′ id*E/E′ S R′ ◻ in case
   ... | id*E/E′ | ◻ , R′ | [ (• ._) ᵇ ] , S | ◻ , P′ | [ (• ._) ᵇ ] , S′ | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] =
      let open │ᵥᵇ 𝐸 F P′ S′ id*E/E′ S R′ ◻ in case
   ... | id*E/E′ | [ ._ • ᵇ ] , R′ | ◻ , S | [ ._ • ᵇ ] , P′ | ◻ , S′ | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] =
      let open │ᵥᵇ 𝐸 F P′ S′ id*E/E′ S R′ ◻ in case
   ... | id*E/E′ | [ ._ • ᵇ ] , R′ | [ (• ._) ᵇ ] , S | [ ._ • ᵇ ] , P′ | [ (• ._) ᵇ ] , S′ | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] =
      let open │ᵥᵇ 𝐸 F P′ S′ id*E/E′ S R′ [ ᴺ.zero ] in case
   ... | id*E/E′ | [ ._ • ᵇ ] , R′ | _ , S | ◻ , P′ | _ , S′ | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] = {!!} -- impossible
   ... | id*E/E′ | ◻ , R′ | _ , S | [ ._ • ᵇ ] , P′ | _ , S′ | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] = {!!} -- impossible
   ... | id*E/E′ | _ , R′ | [ (• ._) ᵇ ] , S | _ , P′ | ◻ , S′ | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] = {!!} -- impossible
   ... | id*E/E′ | _ , R′ | ◻ , S | _ , P′ | [ (• ._) ᵇ ] , S′ | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] = {!!} -- impossible
