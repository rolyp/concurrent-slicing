...
-}
   ...
   gamma₁-│ᵥ′ : ∀ {Γ} {x u : Name Γ} {P₀ Q₀ R₀ R′₀ S₀ S′₀} {E : P₀ —[ x • ᵇ - _ ]→ R₀} {E′ : P₀ —[ u • ᵇ - _ ]→ R′₀}
               ...
               (R : ↓ R₀) (R′ : ↓ R′₀) (S : ↓ S₀) (S′ : ↓ S′₀) →
               ↓ ᵀ.out (E′/E (⊖₁ 𝐸)) → ↓ ᵀ.out (E′/E (⊖₁ 𝐹)) → ↓ ᵀ.out (E/E′ (⊖₁ 𝐸)) → ↓ ᵀ.out (E/E′ (⊖₁ 𝐹)) →
               braid̂ (γ₁ (𝐸 │ᵥ′ 𝐹))
               (π₂ (step⁻ (νᶜ (E′/E (⊖₁ 𝐸) │ᵥ E′/E (⊖₁ 𝐹))) (ν [ R │ S ]))) ≡
               π₂ (step⁻ (νᶜ (E/E′ (⊖₁ 𝐸) │ᵥ E/E′ (⊖₁ 𝐹))) (ν [ R′ │ S′ ]))
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ (◻ , P′) (◻ , Q′) (◻ , P″) (◻ , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ (◻ , P′) (◻ , Q′) (◻ , P″) ([ x₁ ] , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ (◻ , P′) (◻ , Q′) ([ x₁ ] , P″) (◻ , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ (◻ , P′) (◻ , Q′) ([ x₁ ] , P″) ([ x₂ ] , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ (◻ , P′) ([ x₁ ] , Q′) (◻ , P″) (◻ , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ (◻ , P′) ([ x₁ ] , Q′) (◻ , P″) ([ x₂ ] , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ (◻ , P′) ([ x₁ ] , Q′) ([ x₂ ] , P″) (◻ , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ (◻ , P′) ([ x₁ ] , Q′) ([ x₂ ] , P″) ([ x₃ ] , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ ([ x₁ ] , P′) (◻ , Q′) (◻ , P″) (◻ , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ ([ x₁ ] , P′) (◻ , Q′) (◻ , P″) ([ x₂ ] , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ ([ x₁ ] , P′) (◻ , Q′) ([ x₂ ] , P″) (◻ , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ ([ x₁ ] , P′) (◻ , Q′) ([ x₂ ] , P″) ([ x₃ ] , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ ([ x₁ ] , P′) ([ x₂ ] , Q′) (◻ , P″) (◻ , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ ([ x₁ ] , P′) ([ x₂ ] , Q′) (◻ , P″) ([ x₃ ] , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ ([ x₁ ] , P′) ([ x₂ ] , Q′) ([ x₃ ] , P″) (◻ , Q″) = {!!}
   gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ ([ x₁ ] , P′) ([ x₂ ] , Q′) ([ x₃ ] , P″) ([ x₄ ] , Q″) = {!!}
   ...
   gamma₁ {E = E │ᵥ F} {E′ │ᵥ F′} (𝐸 │ᵥ′ 𝐹) [ P │ Q ] |
      ◻ , R′ | ◻ , R | ◻ , S′ | ◻ , S | [ ≡R′ ] | [ ≡R ] | [ ≡S′ ] | [ ≡S ] =
      gamma₁-│ᵥ′ 𝐸 𝐹 R R′ S S′ (step (E′/E (⊖₁ 𝐸)) R) (step (E′/E (⊖₁ 𝐹)) S) (step (E/E′ (⊖₁ 𝐸)) R′) (step (E/E′ (⊖₁ 𝐹)) S′)
{-
