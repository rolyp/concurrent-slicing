...
-}
   ...
   gamma₁ {E = E ᵇ│ Q₀} {E′ │ᵥ .F} (_│ᵥᵇ_ {x = x} {a = x′ •} 𝐸 F) [ P │ Q ]
      with (idᶠ *ᵇ) (E/E′ (⊖₁ 𝐸)) | step E′ P | step F Q | step (E′/E (⊖₁ 𝐸)) (tgt E P) |
           step ((ᴿ.push *ᵇ) F) ((push *̃) Q) | inspect (step E′) P | inspect (step (E′/E (⊖₁ 𝐸))) (tgt E P) |
           inspect (step F) Q | inspect (step ((ᴿ.push *ᵇ) F)) ((push *̃) Q)
   ... | id*E/E′ | ◻ , R′ | ◻ , S | ◻ , P′ | ◻ , S′ | [ ≡R′ ] | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] =
      let open │ᵥᵇ 𝐸 F P Q P′ S′ id*E/E′ S R′ ◻ (,-inj₂ ≡P′) (,-inj₂ ≡S) (,-inj₂ ≡S′) (,-inj₂ ≡R′) (gamma₁ 𝐸 P) in case
   ... | id*E/E′ | ◻ , R′ | [ (• ._) ᵇ ] , S | ◻ , P′ | [ (• ._) ᵇ ] , S′ | [ ≡R′ ] | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] =
      let open │ᵥᵇ 𝐸 F P Q P′ S′ id*E/E′ S R′ ◻ (,-inj₂ ≡P′) (,-inj₂ ≡S) (,-inj₂ ≡S′) (,-inj₂ ≡R′) (gamma₁ 𝐸 P) in case
   ... | id*E/E′ | [ ._ • ᵇ ] , R′ | ◻ , S | [ ._ • ᵇ ] , P′ | ◻ , S′ | [ ≡R′ ] | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] =
      let open │ᵥᵇ 𝐸 F P Q P′ S′ id*E/E′ S R′ ◻ (,-inj₂ ≡P′) (,-inj₂ ≡S) (,-inj₂ ≡S′) (,-inj₂ ≡R′) (gamma₁ 𝐸 P) in case
   ... | id*E/E′ | [ ._ • ᵇ ] , R′ | [ (• ._) ᵇ ] , S | [ ._ • ᵇ ] , P′ | [ (• ._) ᵇ ] , S′ | [ ≡R′ ] | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] =
      let open │ᵥᵇ 𝐸 F P Q P′ S′ id*E/E′ S R′ [ ᴺ.zero ] (,-inj₂ ≡P′) (,-inj₂ ≡S) (,-inj₂ ≡S′) (,-inj₂ ≡R′) (gamma₁ 𝐸 P) in case
   ... | id*E/E′ | [ ._ • ᵇ ] , R′ | _ , S | ◻ , P′ | _ , S′ | [ ≡R′ ] | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] = {!!} -- impossible
   ... | id*E/E′ | ◻ , R′ | _ , S | [ ._ • ᵇ ] , P′ | _ , S′ | [ ≡R′ ] | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] = {!!} -- impossible
   ... | id*E/E′ | _ , R′ | [ (• ._) ᵇ ] , S | _ , P′ | ◻ , S′ | [ ≡R′ ] | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] = {!!} -- impossible
   ... | id*E/E′ | _ , R′ | ◻ , S | _ , P′ | [ (• ._) ᵇ ] , S′ | [ ≡R′ ] | [ ≡P′ ] | [ ≡S ] | [ ≡S′ ] = {!!} -- impossible
