...
module Transition.Concur.Cofinal.Lattice.case.sync-sync
   ...
   ... | ◻ , R | ◻ , R′ | [ .u • ᵇ ] , S | ◻ , S′ | [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | ◻ , R | ◻ , R′ | [ .u • ᵇ ] , S | [ • .u 〈 z′ 〉 ᶜ ] , S′ | [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | ◻ , R | [ • .x 〈 y′ 〉 ᶜ ] , R′ | ◻ , S | ◻ , S′ | [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | ◻ , R | [ • .x 〈 y′ 〉 ᶜ ] , R′ | ◻ , S | [ • .u 〈 z′ 〉 ᶜ ] , S′ | [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | ◻ , R | [ • .x 〈 y′ 〉 ᶜ ] , R′ | [ .u • ᵇ ] , S | ◻ , S′ | [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | ◻ , R | [ • .x 〈 y′ 〉 ᶜ ] , R′ | [ .u • ᵇ ] , S | [ • .u 〈 z′ 〉 ᶜ ] , S′ |
       [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | [ .x • ᵇ ] , R | ◻ , R′ | ◻ , S | ◻ , S′ | [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | [ .x • ᵇ ] , R | ◻ , R′ | ◻ , S | [ • .u 〈 z′ 〉 ᶜ ] , S′ | [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | [ .x • ᵇ ] , R | ◻ , R′ | [ .u • ᵇ ] , S | ◻ , S′ | [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | [ .x • ᵇ ] , R | ◻ , R′ | [ .u • ᵇ ] , S | [ • .u 〈 z′ 〉 ᶜ ] , S′ |
       [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | [ .x • ᵇ ] , R | [ • .x 〈 y′ 〉 ᶜ ] , R′ | ◻ , S | ◻ , S′ | [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | [ .x • ᵇ ] , R | [ • .x 〈 y′ 〉 ᶜ ] , R′ | ◻ , S | [ • .u 〈 z′ 〉 ᶜ ] , S′ |
      [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | [ .x • ᵇ ] , R | [ • .x 〈 y′ 〉 ᶜ ] , R′ | [ .u • ᵇ ] , S | ◻ , S′ |
      [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
   ... | [ .x • ᵇ ] , R | [ • .x 〈 y′ 〉 ᶜ ] , R′ | [ .u • ᵇ ] , S | [ • .u 〈 z′ 〉 ᶜ ] , S′ |
      [ ≡R ] | [ ≡R′ ] | [ ≡S ] | [ ≡S′ ] = {!!}
