...
{-
   ...
   ... | ◻ , _ | [ (◻ •) ᵇ ] , _ | _ , R† = let _ , S† = stepᴹ F Q† in ◻ , [ (ᴹ (pop ◻) *ᴹ) R† │ S† ]
   ... | ◻ , _ | [ ([ x ] •) ᵇ ] , - | _ , R†
      with step F Q′ | stepᴹ F Q†
   ... | ◻ , _ | _ , S† = ◻ , [ (ᴹ (pop ◻) *ᴹ) R† │ S† ]
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , _ | _ , S† = ◻ , [ (ᴹ (pop ◻) *ᴹ) R† │ S† ]
   ... | [ • [ .x ] 〈 y 〉 ᶜ ] , _ | _ , S† = ◻ , [ (popᴹ ◻ *ᴹ) R† │ S† ]
   step⁻ᴹ (E │• F) {P │ Q} {P′ │ Q′} (P† │ Q†) | [ _ ] , _ | ◻ , _ | () , _
   step⁻ᴹ (E │• F) {P │ Q} {P′ │ Q′} (P† │ Q†) | [ ◻ • ᵇ ] , _ | [ ◻ • ᵇ ] , _ | [ (_ •) ᵇ ] , R† =
      let _ , S† = stepᴹ F Q† in ◻ , [ ((ᴹ (pop ◻) *ᴹ) R†) │ S† ]
   step⁻ᴹ (E │• F) {P │ Q} {P′ │ Q′} (P† │ Q†) | [ ◻ • ᵇ ] , _ | [ [ x ] • ᵇ ] , _ | [ (_ •) ᵇ ] , R†
      with step F Q′ | stepᴹ F Q†
   ... | ◻ , _ | _ , S† = ◻ , [ (ᴹ (pop ◻) *ᴹ) R† │ S† ]
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , _ | _ , S† = ◻ , [ (ᴹ (pop ◻) *ᴹ) R† │ S† ]
   ... | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | _ , S† = ◻ , [ (popᴹ ◻ *ᴹ) R† │ S† ]
   step⁻ᴹ (E │• F) {P │ Q} {P′ │ Q′} (P† │ Q†) | [ [ x ] • ᵇ ] , _ | [ ◻ • ᵇ ] , _ | [ () • ᵇ ] , _
   step⁻ᴹ (E │• F) {P │ Q} {P′ │ Q′} (P† │ Q†) | [ [ x ] • ᵇ ] , _ | [ [ .x ] • ᵇ ] , _ | [ _ • ᵇ ] , R†
      with step F Q | step F Q′ | stepᴹ F Q†
   ... | ◻ , _ | ◻ , _ | _ , S† = ◻ , [ (ᴹ (pop ◻) *ᴹ) R† │ S† ]
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , _ | ◻ , _ | _ , S† = ◻ , [ (ᴹ (pop ◻) *ᴹ) R† │ S† ]
   ... | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | ◻ , _ | () , _
   ... | ◻ , _ | [ • ◻ 〈 _ 〉 ᶜ ] , _ | _ , S† = ◻ , [ (ᴹ (pop ◻) *ᴹ) R† │ S† ]
   ... | ◻ , _ | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | _ , S† = ◻ , [ (popᴹ ◻ *ᴹ) R† │ S† ]
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , _ | [ • ◻ 〈 _ 〉 ᶜ ] , _ | _ , S† = ◻ , [ (ᴹ (pop ◻) *ᴹ) R† │ S† ]
   ... | [ • ◻ 〈 _ 〉 ᶜ ] , _ | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | _ , S† = ◻ , [ (popᴹ ◻ *ᴹ) R† │ S† ]
   ... | [ • [ .x ] 〈 _ 〉 ᶜ ] , _ | [ • ◻ 〈 _ 〉 ᶜ ] , _ | [ • () 〈 _ 〉 ᶜ ] , _
   ...
   ... | [ (• ◻) ᵇ ] , _ | _ , S† = ◻ , [ ν [ R† │ S† ] ]
   ... | [ (• [ .x ]) ᵇ ] , _ | _ , S† = ◻ , [ ν [ R† │ S† ] ]
   step⁻ᴹ (E │ᵥ F) {P │ Q} {P′ │ Q′} (P† │ Q†) | [ ([ x ] •) ᵇ ] , _ | [ (◻ •) ᵇ ] , _ | [ (() •) ᵇ ] , _
   ...
   step⁻ᴹ (ν•_ {x = x} E) {ν P} {ν P′} (ν P†) with step E P | step E P′ | stepᴹ E P†
   ... | ◻ , _ | ◻ , _ | ◻ , R† = ◻ , R†
   ... | ◻ , _ | [ • ◻ 〈 _ 〉 ᶜ ] , _ | ◻ , R† = ◻ , R†
   ... | ◻ , _ | [ • [ ._ ] 〈 ◻ 〉 ᶜ ] , _ | ◻ , R† = ◻ , R†
   ... | ◻ , _ | [ • [ ._ ] 〈 [ ._ ] 〉 ᶜ ] , _ | ◻ , R† = ◻ , R†
...
-}
   ...
   step⁻ᴹ {a = (• x) ᵇ} (νᵇ E) {ν P} {ν P′} (ν P†) with step E P | step E P′ | stepᴹ E P†
   ... | ◻ , _ | ◻ , _ | ◻ , R† = ◻ , [ ν (ᴹ swap *ᴹ) R† ]
   ... | ◻ , _ | [ (• ◻) ᵇ ] , _ | ◻ , R† = ◻ , [ ν (ᴹ swap *ᴹ) R† ]
   ... | ◻ , _ | [ (• [ ._ ]) ᵇ ] , _ | ◻ , R† = ◻ , [ ν (ᴹ swap *ᴹ) R† ]
   ... | [ x₁ ] , _ | ◻ , _ | () , _
   ... | [ (• ◻) ᵇ ] , _ | [ (• ◻) ᵇ ] , _ | [ (• ◻) ᵇ ] , R† = ◻ , [ ν (ᴹ swap *ᴹ) R† ]
   ... | [ (• ◻) ᵇ ] , _ | [ (• [ ._ ]) ᵇ ] , _ | [ (• ◻) ᵇ ] , R† = ◻ , [ ν (ᴹ swap *ᴹ) R† ]
   ... | [ (• [ ._ ]) ᵇ ] , _ | [ (• ◻) ᵇ ] , _ | [ (• ()) ᵇ ] , _
   ... | [ (• [ ._ ]) ᵇ ] , _ | [ (• [ ._ ]) ᵇ ] , _ | [ (• [ ._ ]) ᵇ ] , R† = [ (• [ x ]) ᵇ ] , [ ν (ᴹ swap *ᴹ) R† ]
