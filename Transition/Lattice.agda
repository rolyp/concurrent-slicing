module Transition.Lattice where
   ...
   ... | ◻ , _ | ◻ , _ | ◻ , _ | ◻ , _ | ◻ , _ | _ , _ = ◻ , [ {!!} │ {!!} ]
   ... | ◻ , _ | ◻ , _ | a′ , _ | ◻ , _ | [ • x 〈 x₁ 〉 ᶜ ] , _ | b″ , _ = {!!}
   ... | ◻ , _ | ◻ , _ | a′ , _ | [ • x 〈 x₁ 〉 ᶜ ] , _ | ◻ , _ | b″ , _ = {!!}
   ... | ◻ , _ | ◻ , _ | a′ , _ | [ • x 〈 x₁ 〉 ᶜ ] , _ | [ • .x 〈 x₂ 〉 ᶜ ] , _ | b″ , _ = {!!}
   ... | ◻ , _ | [ (x •) ᵇ ] , _ | a′ , _ | ◻ , _ | ◻ , _ | b″ , _ = {!!}
   ... | ◻ , _ | [ (x •) ᵇ ] , _ | a′ , _ | ◻ , _ | [ • .x 〈 x₁ 〉 ᶜ ] , _ | b″ , _ = {!!}
   ... | ◻ , _ | [ (x •) ᵇ ] , _ | a′ , _ | [ • .x 〈 x₁ 〉 ᶜ ] , _ | ◻ , _ | b″ , _ = {!!}
   ... | ◻ , _ | [ (x •) ᵇ ] , _ | a′ , _ | [ • .x 〈 x₁ 〉 ᶜ ] , _ | [ • .x 〈 x₂ 〉 ᶜ ] , _ | b″ , _ = {!!}
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | a′ , _ | ◻ , _ | ◻ , _ | b″ , _ = {!!}
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | a′ , _ | ◻ , _ | [ • .x 〈 x₁ 〉 ᶜ ] , _ | b″ , _ = {!!}
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | a′ , _ | [ • .x 〈 x₁ 〉 ᶜ ] , _ | ◻ , _ | b″ , _ = {!!}
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | a′ , _ | [ • .x 〈 x₁ 〉 ᶜ ] , _ | [ • .x 〈 x₂ 〉 ᶜ ] , _ | b″ , _ = {!!}
   ... | [ (x •) ᵇ ] , _ | [ .x • ᵇ ] , _ | a′ , _ | ◻ , _ | ◻ , _ | b″ , _ = {!!}
   ... | [ (x •) ᵇ ] , _ | [ .x • ᵇ ] , _ | a′ , _ | ◻ , _ | [ • .x 〈 x₁ 〉 ᶜ ] , _ | b″ , _ = {!!}
   ... | [ (x •) ᵇ ] , _ | [ .x • ᵇ ] , _ | a′ , _ | [ • .x 〈 x₁ 〉 ᶜ ] , _ | ◻ , _ | b″ , _ = {!!}
   ... | [ (x •) ᵇ ] , _ | [ (.x •) ᵇ ] , _ | a′ , _ | [ • .x 〈 x₁ 〉 ᶜ ] , _ | [ • .x 〈 x₂ 〉 ᶜ ] , _ | b″ , _ = {!!}
...
{-
   ...
   unstep-◻ (ν• E) ((• x) ᵇ) = ν [ unstep-◻ E (• ᴺ.suc x 〈 zero 〉 ᶜ) ]
   ...
   unstep⁻ᴹ (_│•_ {R = P′} {x = x} {y} E F) {a″ = ◻} {R = R′ │ _} {R″ │ _} ◻ (R │ S)
      with π₁ (unren (ᴿ.pop y) P′ R′) ᴺ.zero | π₁ (unren (ᴿ.pop y) P′ R″) ᴺ.zero | π₁ (unrenᴹ (ᴿ.pop y) P′ R) ᴺ.zero
   ... | ◻ | ◻ | _ = unstepᴹ E (◻ , π₂ (unrenᴹ (ᴿ.pop y) P′ R)) │ unstepᴹ F (◻ , S)
