module Transition.Lattice where
   ...
   ... | ◻ , _ | [ (x •) ᵇ ] , _ | _ , R | [ • .x 〈 _ 〉 ᶜ ] , _ | ◻ , _ | () , _
   ... | ◻ , _ | [ (x •) ᵇ ] , _ | _ , R | [ • .x 〈 _ 〉 ᶜ ] , _ | [ • .x 〈 _ 〉 ᶜ ] , _ | [ • .x 〈 y 〉 ᶜ ] , S =
      {!◻ , [ (popᴹ y *ᴹ) R │ S ]!}
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | _ , R | ◻ , _ | ◻ , _ | _ , S = {!!}
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | _ , R | ◻ , _ | [ • .x 〈 _ 〉 ᶜ ] , _ | _ , S = {!!}
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | _ , R | [ • .x 〈 _ 〉 ᶜ ] , _ | ◻ , _ | _ , S = {!!}
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | _ , R | [ • .x 〈 _ 〉 ᶜ ] , _ | [ • .x 〈 _ 〉 ᶜ ] , _ | _ , S = {!!}
   ... | [ (x •) ᵇ ] , _ | [ .x • ᵇ ] , _ | _ , R | ◻ , _ | ◻ , _ | _ , S = {!!}
   ... | [ (x •) ᵇ ] , _ | [ .x • ᵇ ] , _ | _ , R | ◻ , _ | [ • .x 〈 _ 〉 ᶜ ] , _ | _ , S = {!!}
   ... | [ (x •) ᵇ ] , _ | [ .x • ᵇ ] , _ | _ , R | [ • .x 〈 _ 〉 ᶜ ] , _ | ◻ , _ | _ , S = {!!}
   ... | [ (x •) ᵇ ] , _ | [ (.x •) ᵇ ] , _ | _ , R | [ • .x 〈 _ 〉 ᶜ ] , _ | [ • .x 〈 _ 〉 ᶜ ] , _ | _ , S = {!!}
