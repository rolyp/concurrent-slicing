module Transition.Lattice where
   ...
   ... | [ • .(ᴺ.suc x) 〈 ◻ 〉 ᶜ ] , R = [ (• x ﹝ ◻ ﹚) ᵇ ] , R
   ... | [ • .(ᴺ.suc x) 〈 [ .ᴺ.zero ] 〉 ᶜ ] , R = [ (• x ﹝ [ ᴺ.zero ] ﹚) ᵇ ] , R
   ... | _ , R = ◻ , R
   step⁻ {a = x • ᵇ} (νᵇ E) (ν P) with step E P
   ... | [ .(ᴺ.suc x) • ᵇ ] , R = [ x • ᵇ ] , [ ν (swap *̃) R ]
   ... | ◻ , R = ◻ , [ ν (swap *̃) R ]
   step⁻ {a = (• x) ᵇ} (νᵇ E) (ν P) with step E P
   ... | [ (• .(ᴺ.suc x) ﹝ [ .ᴺ.zero ] ﹚ ) ᵇ ] , R = [ • x ﹝ [ ᴺ.zero ] ﹚ ᵇ ] ,  [ ν (swap *̃) R ]
   ... | [ (• .(ᴺ.suc x) ﹝ ◻ ﹚ ) ᵇ ] , R = [ • x ﹝ ◻ ﹚ ᵇ ] ,  [ ν (swap *̃) R ]
   ... | ◻ , R = ◻ , [ ν (swap *̃) R ]
   ...
   ... | ◻ , _ | [ (x •) ᵇ ] , _ | _ , R | [ • .x 〈 _ 〉 ᶜ ] , _ | [ • .x 〈 _ 〉 ᶜ ] , _ | [ • .x 〈 y 〉 ᶜ ] , S =
      ◻ , [ (popᴹ y *ᴹ) R │ S ]
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | _ , R | ◻ , _ | ◻ , _ | _ , S = ◻ , [ (popᴹ ◻ *ᴹ) R │ S ]
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | _ , R | ◻ , _ | [ • .x 〈 _ 〉 ᶜ ] , _ | _ , S = ◻ , [ (popᴹ ◻ *ᴹ) R │ S ]
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | _ , R | [ • .x 〈 _ 〉 ᶜ ] , _ | ◻ , _ | () , _
   ... | [ (x •) ᵇ ] , _ | ◻ , _ | () , _ | [ • .x 〈 _ 〉 ᶜ ] , _ | [ • .x 〈 _ 〉 ᶜ ] , _ | _ , S
   ... | [ (x •) ᵇ ] , _ | [ .x • ᵇ ] , _ | _ , R | ◻ , _ | ◻ , _ | _ , S = ◻ , [ (popᴹ ◻ *ᴹ) R │ S ]
   ... | [ (x •) ᵇ ] , _ | [ .x • ᵇ ] , _ | _ , R | ◻ , _ | [ • .x 〈 _ 〉 ᶜ ] , _ | _ , S = ◻ , [ (popᴹ ◻ *ᴹ) R │ S ]
   ... | [ (x •) ᵇ ] , _ | [ .x • ᵇ ] , _ | _ , R | [ • .x 〈 _ 〉 ᶜ ] , _ | ◻ , _ | () , _
   ...
   ... | [ • ._ 〈 [ .ᴺ.zero ] 〉 ᶜ ] , _ | [ • ._ 〈 [ .ᴺ.zero ] 〉 ᶜ ] , _ | _ , R† = [ • x ﹝ [ ᴺ.zero ] ﹚ ᵇ ] , R†
