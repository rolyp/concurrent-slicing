module Transition.Lattice.GaloisConnection where
   ...
   ... | [ (._ •) ᵇ ] , _ | [ • ._ ﹙ y ﹚ ᵇ ] , _ | [ ._ • ᵇ ] | [ • ._ ﹙ y′ ﹚ ᵇ ] = [ τ ᶜ ]
   id≤step⁻∘unstep-◻ (ν• E) (• x ﹙ ◻ ﹚ ᵇ)
      with step⁻ E (unstep-◻ E (• ᴺ.suc x 〈 ◻ 〉 ᶜ)) | id≤step⁻∘unstep-◻ E (• ᴺ.suc x 〈 ◻ 〉 ᶜ)
   ... | ◻ , _ | ()
   ... | [ • .(ᴺ.suc x) 〈 ◻ 〉 ᶜ ] , _ | _ = [ • x ﹙ ◻ ﹚ ᵇ ]
   ... | [ • .(ᴺ.suc x) 〈 [ .ᴺ.zero ] 〉 ᶜ ] , proj₂ | b = [ • x ﹙ ◻ ﹚ ᵇ ]
   id≤step⁻∘unstep-◻ (ν• E) (• x ﹙ [ .ᴺ.zero ] ﹚ ᵇ)
      with step⁻ E (unstep-◻ E (• ᴺ.suc x 〈 zero 〉 ᶜ)) | id≤step⁻∘unstep-◻ E (• ᴺ.suc x 〈 zero 〉 ᶜ)
   ... | [ • ._ 〈 [ ._ ] 〉 ᶜ ] , _ | [ • ._ 〈 [ ._ ] 〉 ᶜ ] = [ • x ﹙ [ ᴺ.zero ] ﹚ ᵇ ]
   id≤step⁻∘unstep-◻ {a = x • ᵇ} (νᵇ E) (._ • ᵇ)
      with step⁻ E (unstep-◻ E (ᴺ.suc x • ᵇ)) | id≤step⁻∘unstep-◻ E (ᴺ.suc x • ᵇ)
   ... | [ ._ • ᵇ ] , _ | [ ._ • ᵇ ] = [ x • ᵇ ]
   id≤step⁻∘unstep-◻ {a = (• .x) ᵇ} (νᵇ E) (• x ﹙ ◻ ﹚ ᵇ)
      with step⁻ E (unstep-◻ E (• ᴺ.suc x ﹙ ◻ ﹚ ᵇ)) | id≤step⁻∘unstep-◻ E (• ᴺ.suc x ﹙ ◻ ﹚ ᵇ)
   ... | [ • .(ᴺ.suc x) ﹙ ◻ ﹚ ᵇ ] , _ | [ • .(ᴺ.suc x) ﹙ y′ ﹚ ᵇ ] = [ • x ﹙ ◻ ﹚ ᵇ ]
   ... | [ • .(ᴺ.suc x) ﹙ [ .ᴺ.zero ] ﹚ ᵇ ] , _ | [ • .(ᴺ.suc x) ﹙ y′ ﹚ ᵇ ] = [ • x ﹙ ◻ ﹚ ᵇ ]
   id≤step⁻∘unstep-◻ {a = (• .x) ᵇ} (νᵇ E) (• x ﹙ [ .ᴺ.zero ] ﹚ ᵇ)
      with step⁻ E (unstep-◻ E (• ᴺ.suc x ﹙ zero ﹚ ᵇ)) | id≤step⁻∘unstep-◻ E (• ᴺ.suc x ﹙ zero ﹚ ᵇ)
   ... | [ • .(ᴺ.suc x) ﹙ ◻ ﹚ ᵇ ] , _ | [ • .(ᴺ.suc x) ﹙ () ﹚ ᵇ ]
   ... | [ • .(ᴺ.suc x) ﹙ [ .ᴺ.zero ] ﹚ ᵇ ] , _ | [ • .(ᴺ.suc x) ﹙ y′ ﹚ ᵇ ] = [ • x ﹙ [ ᴺ.zero ] ﹚ ᵇ ]
   ...
   ... | ◻ , _ | _ , _ | _ , P | _ , Q = ◻ , [ ν ◻ ]
   ... | [ .x • ᵇ ] , _ | ◻ , _ | _ , P | _ , Q = ◻ , [ ν ◻ ]
   ... | [ .x • ᵇ ] , _ | [ • .x ﹙ y ﹚ ᵇ ] , _ | _ , P | _ , Q = ◻ , [ ν ◻ ]
   id≤step⁻∘unstep⁻ (_│ᵥ_ {x = x} E F) [ τ ᶜ ] (ν ◻)
      with step⁻ E (unstep-◻ E (x • ᵇ)) | step⁻ F (unstep-◻ F (• x ﹙ ◻ ﹚ ᵇ)) |
           id≤step⁻∘unstep-◻ E (x • ᵇ) | id≤step⁻∘unstep-◻ F (• x ﹙ ◻ ﹚ ᵇ)
   ... | [ .x • ᵇ ] , _ | [ • .x ﹙ y ﹚ ᵇ ] , _ | [ ._ • ᵇ ] | [ • .x ﹙ y′ ﹚ ᵇ ] = [ τ ᶜ ] , [ ν ◻ ]
   id≤step⁻∘unstep⁻ (E │ᵥ F) ◻ (ν [ R │ S ])
      with π₁ (unren idᶠ (ᵀ.tgt E) R) ᴺ.zero | repl-top (π₁ (unren idᶠ (ᵀ.tgt E) R))
   id≤step⁻∘unstep⁻ (E │ᵥ F) ◻ (ν [ R │ S ]) | ◻ | repl′
      with step E (unstep E (◻ , π₂ (unren idᶠ (ᵀ.tgt E) R))) | step F (unstep F (◻ , S)) |
           id≤step∘unstep E (◻ , π₂ (unren idᶠ (ᵀ.tgt E) R)) | id≤step∘unstep F (◻ , S)
   ... | ◻ , R† | ◻ , S′ | _ , P | _ , Q =
      ◻ , [ ν [ ≤-trans (id≤ren∘unren idᶠ (ᵀ.tgt E) R) ((repl′ *ᴹ) P) │ Q ] ]
   ... | ◻ , R† | [ • ._ ﹙ y ﹚ ᵇ ] , S′ | _ , P | _ , Q =
      ◻ , [ ν [ ≤-trans (id≤ren∘unren idᶠ (ᵀ.tgt E) R) ((≤-trans repl′ (replᴹ ◻) *ᴹ) P) │ Q ] ]
   ... | [ x • ᵇ ] , R† | ◻ , S′ | _ , P | _ , Q =
      ◻ , [ ν [ ≤-trans (id≤ren∘unren idᶠ (ᵀ.tgt E) R) ((repl′ *ᴹ) P) │ Q ] ]
   ... | [ x • ᵇ ] , R† | [ • .x ﹙ y ﹚ ᵇ ] , S′ | _ , P | _ , Q =
      ◻ , [ ν [ ≤-trans (id≤ren∘unren idᶠ (ᵀ.tgt E) R) ((≤-trans repl′ (replᴹ ◻) *ᴹ) P) │ Q ] ]
   id≤step⁻∘unstep⁻ (E │ᵥ F) ◻ (ν [ R │ S ]) | [ .ᴺ.zero ] | repl′
      with step E (unstep E (◻ , π₂ (unren idᶠ (ᵀ.tgt E) R))) |
           step F (unstep F ([ • _ ﹙ zero ﹚ ᵇ ] , S)) |
           id≤step∘unstep E (◻ , π₂ (unren idᶠ (ᵀ.tgt E) R)) |
           id≤step∘unstep F ([ • _ ﹙ zero ﹚ ᵇ ] , S)
   ... | ◻ , R† | ◻ , S′ | _ | () , Q
   ... | [ x • ᵇ ] , R† | ◻ , S′ | _ | () , Q
   ... | ◻ , R† | [ • x ﹙ y ﹚ ᵇ ] , S′ | _ , P | [ • .x ﹙ y′ ﹚ ᵇ ] , Q =
      ◻ , [ ν [ ≤-trans (id≤ren∘unren idᶠ (ᵀ.tgt E) R) ((≤-trans repl′ (replᴹ y′) *ᴹ) P) │ Q ] ]
   ... | [ x • ᵇ ] , R† | [ • .x ﹙ y ﹚ ᵇ ] , S′ | _ , P | [ • .x ﹙ y′ ﹚ ᵇ ] , Q =
      ◻ , [ ν [ ≤-trans (id≤ren∘unren idᶠ (ᵀ.tgt E) R) ((≤-trans repl′ (replᴹ y′) *ᴹ) P) │ Q ] ]
   id≤step⁻∘unstep⁻ (_│ᵥ_ {x = x} E F) [ τ ᶜ ] (ν [ R │ S ])
      with step E (unstep E ([ x • ᵇ ] , π₂ (unren idᶠ (ᵀ.tgt E) R))) |
           step F (unstep F ([ • x ﹙ π₁ (unren idᶠ (ᵀ.tgt E) R) ᴺ.zero ﹚ ᵇ ] , S)) |
           id≤step∘unstep E ([ x • ᵇ ] , π₂ (unren idᶠ (ᵀ.tgt E) R)) |
           id≤step∘unstep F ([ • x ﹙ π₁ (unren idᶠ (ᵀ.tgt E) R) ᴺ.zero ﹚ ᵇ ] , S)
   ... | [ .x • ᵇ ] , _ | [ • .x ﹙ y ﹚ ᵇ ] , _ | [ ._ • ᵇ ] , P | [ • ._ ﹙ y′ ﹚ ᵇ ] , Q =
       let repl′ = ≤-trans (repl-top (π₁ (unren idᶠ (ᵀ.tgt E) R))) (replᴹ y′) in
       [ τ ᶜ ] , [ ν [ ≤-trans (id≤ren∘unren idᶠ (ᵀ.tgt E) R) ((repl′ *ᴹ) P) │ Q ] ]
   ...
   ... | [ • ._ 〈 ◻ 〉 ᶜ ] , _ | [ • ._ 〈 ◻ 〉 ᶜ ] , P = [ • x ﹙ ◻ ﹚ ᵇ ] , P
   ... | [ • ._ 〈 [ .ᴺ.zero ] 〉 ᶜ ] , _ | [ • ._ 〈 ◻ 〉 ᶜ ] , P = [ • x ﹙ ◻ ﹚ ᵇ ] , P
   id≤step⁻∘unstep⁻ (ν• E) [ • x ﹙ [ .ᴺ.zero ] ﹚ ᵇ ] R
   ...
   ... | ◻ | _ = [ ≤-trans (unstepᴹ E (◻ , π₂ (unren∘ren≤id (ᴿ̃.pop ◻) R′))) P │ Q ]
   ... | [ .y ] | ()
   unstep∘step⁻≤id (_│•_ {y = y} E F) (R │ S) | ◻ , R′ | [ • x 〈 y′ 〉 ᶜ ] , S′ | P | Q
      with π₁ (unren (pop y) (ᵀ.tgt E) ((ᴿ̃.pop y′ *̃) R′)) ᴺ.zero | π₁ (unren∘ren≤id (ᴿ̃.pop y′) R′) ᴺ.zero
   ... | ◻ | _ =
      [ ≤-trans (unstepᴹ E (◻ , π₂ (unren∘ren≤id (ᴿ̃.pop y′) R′))) P │ ≤-trans (unstepᴹ F (◻ , ᴹ S′)) Q ]
   unstep∘step⁻≤id (_│•_ {y = y} E F) (R │ S) | ◻ , R′ | [ • x 〈 [ .y ] 〉 ᶜ ] , S′ | P | Q |
      [ .y ] | [ .y ] = [ ≤-trans (unstepᴹ E (◻ , π₂ (unren∘ren≤id (ᴿ̃.pop [ y ]) R′))) P │ Q ]
   unstep∘step⁻≤id (_│•_ {y = y} E F) (R │ S) | [ x • ᵇ ] , R′ | ◻ , S′ | P | Q
      with π₁ (unren (pop y) (ᵀ.tgt E) ((ᴿ̃.pop ◻ *̃) R′)) ᴺ.zero | π₁ (unren∘ren≤id (ᴿ̃.pop {x₀ = y} ◻) R′) ᴺ.zero
   ... | ◻ | _ = [ ≤-trans (unstepᴹ E (◻ , π₂ (unren∘ren≤id (ᴿ̃.pop ◻) R′))) P │ Q ]
   ... | [ .y ] | ()
   unstep∘step⁻≤id (_│•_ {y = y} E F) (R │ S) | [ x • ᵇ ] , R′ | [ • .x 〈 y′ 〉 ᶜ ] , S′ | P | Q =
   ...
   unstep∘step⁻≤id (E │ᵥ F) (R │ S)
      with step E R | step F S | unstep∘step≤id E R | unstep∘step≤id F S
   ... | ◻ , R′ | ◻ , _ | P | Q
      with π₁ (unren idᶠ (ᵀ.tgt E) ((repl ◻ *̃) R′)) ᴺ.zero | π₁ (unren∘ren≤id (repl ◻) R′) ᴺ.zero
   ... | ◻ | _ = [ ≤-trans (unstepᴹ E (◻ , π₂ (unren∘ren≤id (repl ◻) R′))) P │ Q ]
   ... | [ .ᴺ.zero ] | ()
   unstep∘step⁻≤id (E │ᵥ F) (R │ S) | ◻ , R′ | [ • x ﹙ y ﹚ ᵇ ] , S′ | P | Q
      with π₁ (unren idᶠ (ᵀ.tgt E) ((repl y *̃) R′)) ᴺ.zero | π₁ (unren∘ren≤id (repl y) R′) ᴺ.zero
   ... | ◻ | _ = [ ≤-trans (unstepᴹ E (◻ , π₂ (unren∘ren≤id (repl y) R′))) P │ ≤-trans (unstepᴹ F (◻ , ᴹ S′)) Q ]
   unstep∘step⁻≤id (E │ᵥ F) (R │ S) | ◻ , R′ | [ • x ﹙ [ .ᴺ.zero ] ﹚ ᵇ ] , S′ | P | Q | [ .ᴺ.zero ] | [ .ᴺ.zero ]  =
      [ ≤-trans (unstepᴹ E (◻ , π₂ (unren∘ren≤id (repl [ ᴺ.zero ]) R′))) P │ Q ]
   unstep∘step⁻≤id (E │ᵥ F) (R │ S) | [ ._ • ᵇ ] , R′ | ◻ , _ | P | Q
      with π₁ (unren idᶠ (ᵀ.tgt E) ((repl ◻ *̃) R′)) ᴺ.zero | π₁ (unren∘ren≤id (repl ◻) R′) ᴺ.zero
   ... | ◻ | _ = [ ≤-trans (unstepᴹ E (◻ , π₂ (unren∘ren≤id (repl ◻) R′))) P │ Q ]
   ... | [ .ᴺ.zero ] | ()
   unstep∘step⁻≤id (E │ᵥ F) (R │ S) | [ x • ᵇ ] , R′ | [ • .x ﹙ y ﹚ ᵇ ] , S′ | P | Q =
      [ ≤-trans (unstepᴹ E ([ x • ᵇ ] , π₂ (unren∘ren≤id (repl y) R′))) P │
        ≤-trans (unstepᴹ F ([ • x ﹙ π₁ (unren∘ren≤id (repl y) R′) ᴺ.zero ﹚ ᵇ ] , ᴹ S′)) Q ]
   ...
   ... | [ • .(ᴺ.suc x) ﹙ ◻ ﹚ ᵇ ] , R′ | P =
      [ ν (≤-trans (unstepᴹ E ([ • ᴺ.suc x ﹙ ◻ ﹚ ᵇ ] , π₂ (unren∘ren≤id ᴿ̃.swap R′))) P) ]
   ... | [ • .(ᴺ.suc x) ﹙ [ .ᴺ.zero ] ﹚ ᵇ ] , R′ | P =
      [ ν (≤-trans (unstepᴹ E ([ • ᴺ.suc x ﹙ [ ᴺ.zero ] ﹚ ᵇ ] , π₂ (unren∘ren≤id ᴿ̃.swap R′))) P) ]
